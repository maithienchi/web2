...
class Transaction extends Model {
    ...
    static add(trans_code, type_transfer, from_account_number, to_account_number, beneficiary_unit, toBank, debited, credited, fee, content, current_balance, status, isOutSide, OTP_code, isCustomerAuth, accountId) {
        return Transaction.create({ trans_code, type_transfer, from_account_number, to_account_number, beneficiary_unit, toBank, debited, credited, fee, content, current_balance, status, isOutSide, OTP_code, isCustomerAuth, accountId });
    }
}
Transaction.init({
    trans_code: {
